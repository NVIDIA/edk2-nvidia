...
#ifndef __NVMM_STANDALONEMMCORE_ENTRY_POINT_H__
#define __NVMM_STANDALONEMMCORE_ENTRY_POINT_H__
...
typedef struct {
  ...
  EFI_MM_DEVICE_REGION             SpNsRegions[NS_MAX_REGIONS];
