...
#define EFI_NV_FW_UEFI_EC_M2_NOT_DETECTED                          (EFI_NV_FIRMWARE_UEFI | 0x00000002)
#define EFI_NV_FW_UEFI_EC_M2_NO_EFI_PARTITION                      (EFI_NV_FIRMWARE_UEFI | 0x00000003)
#define EFI_NV_FW_UEFI_EC_M2_PARTITION_NOT_FAT                     (EFI_NV_FIRMWARE_UEFI | 0x00000004)
#define EFI_NV_FW_UEFI_EC_M2_NOT_NVME                              (EFI_NV_FIRMWARE_UEFI | 0x00000005)
#define EFI_NV_FW_UEFI_EC_REDFISH_MAC_INVALID                      (EFI_NV_FIRMWARE_UEFI | 0x00000006)
#define EFI_NV_FW_UEFI_EC_REDFISH_HOST_IP4_INVALID                 (EFI_NV_FIRMWARE_UEFI | 0x00000007)
#define EFI_NV_FW_UEFI_EC_REDFISH_HOST_IP4_SUBNET_MASK_INVALID     (EFI_NV_FIRMWARE_UEFI | 0x00000008)
#define EFI_NV_FW_UEFI_EC_REDFISH_SERVICE_IP4_INVALID              (EFI_NV_FIRMWARE_UEFI | 0x00000009)
#define EFI_NV_FW_UEFI_EC_REDFISH_SERVICE_IP4_SUBNET_MASK_INVALID  (EFI_NV_FIRMWARE_UEFI | 0x0000000A)
#define EFI_NV_FW_UEFI_EC_REDFISH_HOST_IP6_INVALID                 (EFI_NV_FIRMWARE_UEFI | 0x0000000B)
#define EFI_NV_FW_UEFI_EC_REDFISH_HOST_IP6_SUBNET_MASK_INVALID     (EFI_NV_FIRMWARE_UEFI | 0x0000000C)
#define EFI_NV_FW_UEFI_EC_REDFISH_SERVICE_IP6_INVALID              (EFI_NV_FIRMWARE_UEFI | 0x0000000D)
#define EFI_NV_FW_UEFI_EC_REDFISH_SERVICE_IP6_SUBNET_MASK_INVALID  (EFI_NV_FIRMWARE_UEFI | 0x0000000E)
#define EFI_NV_FW_UEFI_EC_REDFISH_BOOTSTRAP_CREDENTIAL_FAILED      (EFI_NV_FIRMWARE_UEFI | 0x0000000F)
#define EFI_NV_FW_UEFI_EC_REDFISH_CONFIG_CHANGED_AND_REBOOT        (EFI_NV_FIRMWARE_UEFI | 0x00000010)
#define EFI_NV_FW_UEFI_EC_TPM_INACCESSIBLE                         (EFI_NV_FIRMWARE_UEFI | 0x00000011)
#define EFI_NV_FW_UEFI_EC_TPM_NOT_INITIALIZED                      (EFI_NV_FIRMWARE_UEFI | 0x00000012)
#define EFI_NV_FW_UEFI_EC_TPM_PCR_BANK_NOT_SUPPORTED               (EFI_NV_FIRMWARE_UEFI | 0x00000013)
#define EFI_NV_FW_UEFI_EC_TPM_SELF_TEST_FAILED                     (EFI_NV_FIRMWARE_UEFI | 0x00000014)
...
///
/// Nvidia Firmware UEFI progress code definitions.
///
///@{

#define EFI_NV_FW_UEFI_PC_SECURE_BOOT_ENABLED   (EFI_NV_FIRMWARE_UEFI | 0x00000001)
#define EFI_NV_FW_UEFI_PC_SECURE_BOOT_DISABLED  (EFI_NV_FIRMWARE_UEFI | 0x00000002)
///@}
