...
#define TH500_PCIE_FLOORSWEEPING_DISABLE_SHIFT  0

#define TH500_PCIE_ID_TO_SOCKET_SHIFT    4
#define TH500_PCIE_ID_TO_INTERFACE_MASK  0xfUL
...
// SCF instances
#define TH500_SCF_CACHE_INSTANCES_PER_SOCKET  96
