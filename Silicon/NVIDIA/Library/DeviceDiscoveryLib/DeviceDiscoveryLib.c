  ...
  )
{
  ...
  RegProperty = fdt_getprop (DeviceTreeBase,
                           NodeOffset,
                           "reg",
                           &PropertySize);
  if (NULL != RegProperty) {
  ...
  SharedMemProperty = fdt_getprop (DeviceTreeBase,
                           NodeOffset,
                           "shmem",
                           &PropertySize);
  ...
  )
{
  ...
  while (DeviceInfo->NodeOffset >= 0) {
    ...
    Property = fdt_getprop (DeviceInfo->DeviceTreeBase,
