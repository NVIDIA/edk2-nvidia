...
RETURN_STATUS
EFIAPI
TegraSbsaSerialPortSetAttributes (
  IN     UINTN               SerialRegisterBase,
...
RETURN_STATUS
EFIAPI
TegraSbsaSerialPortSetControl (
  IN  UINTN  SerialRegisterBase,
  IN UINT32  Control
  )
{
  return PL011UartSetControl (SerialRegisterBase, Control);
}
