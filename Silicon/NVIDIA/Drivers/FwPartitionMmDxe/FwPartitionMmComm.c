  ...
  )
{
  ...
  Status = mMmCommProtocol->Communicate (mMmCommProtocol,
                                         mMmCommBufferPhysical,
                                         mMmCommBuffer,
                                         &CommSize);
  DEBUG ((DEBUG_INFO, "%a: communicate returned: %r\n",
          __FUNCTION__, Status));
  if (EFI_ERROR (Status)) {
    return Status;
  }
  ...
  )
{
  ...
  Status = MmInitCommBuffer ((VOID **) &InitPayload, PayloadSize,
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_ERROR, "%a: Error initializing MM: %r\n",
            __FUNCTION__, Status));
  }
  ...
  )
{
  ...
  Status = MmInitCommBuffer ((VOID **) &GetPartitionsPayload, PayloadSize,
  ...
  Status = MmSendCommBuffer (PayloadSize);
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_ERROR, "%a: Error getting MM image names: %r\n",
            __FUNCTION__, Status));
    return Status;
  }
  ...
  )
{
  ...
  Status = MmInitCommBuffer ((VOID **) &ReadDataPayload, PayloadSize,
  ...
  Status = StrnCpyS (ReadDataPayload->Name,
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((DEBUG_ERROR, "%a: read of %s Offset=%llu Bytes=%u failed: %r\n",
            __FUNCTION__, Name, Offset, Bytes, Status));
    return Status;
  }
  ...
  )
{
  ...
  Status = MmInitCommBuffer ((VOID **) &WriteDataPayload, PayloadSize,
  ...
  Status = StrnCpyS (WriteDataPayload->Name,
