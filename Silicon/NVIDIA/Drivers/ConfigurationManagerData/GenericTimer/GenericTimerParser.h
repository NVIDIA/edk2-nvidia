...
#define GTDT_GLOBAL_FLAGS_MAPPED      \
          EFI_ACPI_6_6_GTDT_GLOBAL_FLAG_MEMORY_MAPPED_BLOCK_PRESENT
#define GTDT_GLOBAL_FLAGS_NOT_MAPPED  0
#define GTDT_GLOBAL_FLAGS_EDGE        \
          EFI_ACPI_6_6_GTDT_GLOBAL_FLAG_INTERRUPT_MODE
...
#define GTDT_TIMER_EDGE_TRIGGERED   \
          EFI_ACPI_6_6_GTDT_TIMER_FLAG_TIMER_INTERRUPT_MODE
#define GTDT_TIMER_LEVEL_TRIGGERED  0
#define GTDT_TIMER_ACTIVE_LOW       \
          EFI_ACPI_6_6_GTDT_TIMER_FLAG_TIMER_INTERRUPT_POLARITY
#define GTDT_TIMER_ACTIVE_HIGH  0
#define GTDT_TIMER_SAVE_CONTEXT     \
          EFI_ACPI_6_6_GTDT_TIMER_FLAG_ALWAYS_ON_CAPABILITY
