...
CM_STD_OBJ_ACPI_TABLE_INFO  CmAcpiTableList[] = {
  ...
  // GTDT Table
  {
    EFI_ACPI_6_6_GENERIC_TIMER_DESCRIPTION_TABLE_SIGNATURE,
  ...
  // DSDT Table
  {
    EFI_ACPI_6_6_DIFFERENTIATED_SYSTEM_DESCRIPTION_TABLE_SIGNATURE,
    EFI_ACPI_6_6_DIFFERENTIATED_SYSTEM_DESCRIPTION_TABLE_REVISION,
  ...
  // SSDT Table - Cpu Topology
  {
    ...
    EFI_ACPI_6_6_SECONDARY_SYSTEM_DESCRIPTION_TABLE_REVISION,
  ...
  )
{
  ...
  for (Index = 0; Index < ARRAY_SIZE (CmAcpiTableList); Index++) {
    ...
    if (CmAcpiTableList[Index].AcpiTableSignature == EFI_ACPI_6_6_DIFFERENTIATED_SYSTEM_DESCRIPTION_TABLE_SIGNATURE) {
