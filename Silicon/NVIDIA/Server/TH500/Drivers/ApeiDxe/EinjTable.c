...
typedef struct {
  EFI_ACPI_6_6_ERROR_INJECTION_TABLE_HEADER        Header;
  EFI_ACPI_6_6_EINJ_INJECTION_INSTRUCTION_ENTRY    Entries[EINJ_ENTRIES_COUNT];
} EINJ_WITH_ENTRIES;

STATIC EINJ_WITH_ENTRIES  EinjTable = {
  .Header                                                    = {
    .Header                                                  = {
      .Signature       = EFI_ACPI_6_6_ERROR_INJECTION_TABLE_SIGNATURE,
      .Length          = sizeof (EINJ_WITH_ENTRIES),
      .Revision        = EFI_ACPI_6_6_ERROR_INJECTION_TABLE_REVISION,
    ...
    .InjectionHeaderSize                                     = sizeof (EFI_ACPI_6_6_ERROR_INJECTION_TABLE_HEADER) -
   ...
   */
  .Entries[EFI_ACPI_6_6_EINJ_BEGIN_INJECTION_OPERATION] = {
    .InjectionAction = EFI_ACPI_6_6_EINJ_BEGIN_INJECTION_OPERATION,
    .Instruction     = EFI_ACPI_6_6_EINJ_NOOP
  },
   ...
   */
  .Entries[EFI_ACPI_6_6_EINJ_GET_TRIGGER_ERROR_ACTION_TABLE] = {
    .InjectionAction = EFI_ACPI_6_6_EINJ_GET_TRIGGER_ERROR_ACTION_TABLE,
    .Instruction     = EFI_ACPI_6_6_EINJ_READ_REGISTER,
    .RegisterRegion  = {
   ...
   */
  .Entries[EFI_ACPI_6_6_EINJ_SET_ERROR_TYPE] = {
    .InjectionAction = EFI_ACPI_6_6_EINJ_SET_ERROR_TYPE,
    .Instruction     = EFI_ACPI_6_6_EINJ_NOOP
  },
   ...
   * RAS_FW_EINJ_COMM_STRUCT.
   */
  .Entries[EFI_ACPI_6_6_EINJ_GET_ERROR_TYPE] = {
    .InjectionAction = EFI_ACPI_6_6_EINJ_GET_ERROR_TYPE,
    .Instruction     = EFI_ACPI_6_6_EINJ_READ_REGISTER,
    .RegisterRegion  = {
      .AddressSpaceId    = EFI_ACPI_6_6_SYSTEM_MEMORY,
      .RegisterBitWidth  = 64,
   ...
   * Implementation: No-op
   */
  .Entries[EFI_ACPI_6_6_EINJ_END_OPERATION] = {
    .InjectionAction = EFI_ACPI_6_6_EINJ_END_OPERATION,
    .Instruction     = EFI_ACPI_6_6_EINJ_NOOP
  },
   ...
   * Action table)
   */
  .Entries[EFI_ACPI_6_6_EINJ_EXECUTE_OPERATION] = {
    .InjectionAction = EFI_ACPI_6_6_EINJ_EXECUTE_OPERATION,
    .Instruction     = EFI_ACPI_6_6_EINJ_NOOP
  },
   ...
   * RAS_FW_EINJ_COMM_STRUCT.
   */
  .Entries[EFI_ACPI_6_6_EINJ_CHECK_BUSY_STATUS] = {
    .InjectionAction = EFI_ACPI_6_6_EINJ_CHECK_BUSY_STATUS,
    .Instruction     = EFI_ACPI_6_6_EINJ_READ_REGISTER,
    .RegisterRegion  = {
      .AddressSpaceId    = EFI_ACPI_6_6_SYSTEM_MEMORY,
      .RegisterBitWidth  = 64,
   ...
   * RAS_FW_EINJ_COMM_STRUCT.
   */
  .Entries[EFI_ACPI_6_6_EINJ_GET_COMMAND_STATUS] = {
    .InjectionAction = EFI_ACPI_6_6_EINJ_GET_COMMAND_STATUS,
    .Instruction     = EFI_ACPI_6_6_EINJ_READ_REGISTER,
    .RegisterRegion  = {
      .AddressSpaceId    = EFI_ACPI_6_6_SYSTEM_MEMORY,
      .RegisterBitWidth  = 64,
  ...
  .Entries[EFI_ACPI_6_X_EINJ_SET_ERROR_TYPE_WITH_ADDRESS] = {
    ...
    .Instruction     = EFI_ACPI_6_6_EINJ_WRITE_REGISTER,
    .RegisterRegion  = {
      .AddressSpaceId    = EFI_ACPI_6_6_SYSTEM_MEMORY,
      .RegisterBitWidth  = 64,
      .RegisterBitOffset = 0,
...
EFI_ACPI_6_X_EINJ_TRIGGER_ERROR_ACTION_TABLE
  ...
  .Header                = {
    .HeaderSize = sizeof (EFI_ACPI_6_6_EINJ_TRIGGER_ACTION_TABLE),
    .Revision   = 1,
    .TableSize  = sizeof (EFI_ACPI_6_X_EINJ_TRIGGER_ERROR_ACTION_TABLE),
    .EntryCount = EINJ_TRIGGER_ACTION_COUNT
  },
  .TriggerActions[0] = {
    .InjectionAction = EFI_ACPI_6_6_EINJ_TRIGGER_ERROR,
    .Instruction     = EFI_ACPI_6_6_EINJ_WRITE_REGISTER_VALUE,
    .RegisterRegion  = {
      .AddressSpaceId    = EFI_ACPI_6_6_SYSTEM_MEMORY,
      .RegisterBitWidth  = 32,
      .RegisterBitOffset = 0,
...
{
  UINTN                                          TableHandle;
  EFI_ACPI_6_6_EINJ_INJECTION_INSTRUCTION_ENTRY  *Entry;
  ...
  Entry                         = &(EinjTable.Entries[EFI_ACPI_6_6_EINJ_GET_TRIGGER_ERROR_ACTION_TABLE]);
  Entry->RegisterRegion.Address = EinjComm->TriggerActionTableRegister;

  Entry                         = &(EinjTable.Entries[EFI_ACPI_6_6_EINJ_GET_ERROR_TYPE]);
  Entry->RegisterRegion.Address = (UINT64)&(EinjComm->SupportedTypes);

  Entry                         = &(EinjTable.Entries[EFI_ACPI_6_6_EINJ_CHECK_BUSY_STATUS]);
  Entry->RegisterRegion.Address = (UINT64)&(EinjComm->Busy);

  Entry                         = &(EinjTable.Entries[EFI_ACPI_6_6_EINJ_GET_COMMAND_STATUS]);
  ...
  )
{
  ...
  if (EinjComm->Signature == EINJ_DISABLED_SIGNATURE) {
    ...
    return EFI_SUCCESS;
  } else if (EinjComm->Signature != EFI_ACPI_6_6_ERROR_INJECTION_TABLE_SIGNATURE) {
