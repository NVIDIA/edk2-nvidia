...
class JetsonFFAMinimalSettingsManager(NVIDIASettingsManager):
    ''' SettingsManager for NVIDIA's JetsonFF-A platform. '''

    def GetName(self):
        return "JetsonFF-AMinimal"
    ...
    def GetConfigFiles(self):
        return [
            self.GetEdk2NvidiaDir() + "Platform/NVIDIA/JetsonFF-AMinimal/JetsonFF-AMinimal.defconfig"
        ]

class PlatformBuilder(NVIDIAPlatformBuilder):
    ''' PlatformBuilder for NVIDIA's JetsonFF-A. '''
    SettingsManager = JetsonFFAMinimalSettingsManager
